...
title: 🎂25.10.21 · 陈梓心
# 你可以自定义封面图片
cover: /assets/images/czx-cover.jpg
# 这是页面的图标
icon: birthday-cake
# 这是侧边栏的顺序
order: 1
...
.birthday-aurora {
        ...
        background: url('/assets/images/czx-1.jpg') no-repeat center center; 
...
<div class="birthday-aurora">
    <div class="hero">
        <h1 class="hero-title">🎉 陈梓心 🎉</h1>
        <div class="title-underline"></div>
        <p class="hero-sub" style="color: #f0f0f0;">🎂 10月21日生日快乐 🎂</p>     <div class="fancy-effect">
    ...
    <div class="info">
        ...
        <div class="info-item">
            ...
            <div class="tag-chips">
                ...
                <span class="chip">创造力</span>
                <span class="chip">团队合作</span>
            </div>
        </div>
    </div>
...
从团支书到组织委员，你始终是把同学们“拧成一股绳”的那个人：沟通细致、统筹有序，关键时刻稳住节奏，把细节做满，让每一次班级活动都有温度、有记忆。  
新的一岁，愿你在组织与创意之间继续进阶，影响力与领导力双向奔赴，所愿皆如愿，所行皆有光。

<div class="stats">
    <div class="card">
        <span class="num">10/10</span>
        <div class="lab">组织力指数</div>
    </div>
    <div class="card">
        <span class="num">100%</span>
        <div class="lab">班级凝聚力加成</div>
    </div>
    <div class="card">
        <span class="num">∞</span>
...
<div class="note gold">
    ...
    <div class="content">
        感谢你一路的担当与热爱：方案周到、执行稳妥、临场冷静，把繁杂化为秩序，把心意落到细节。生日快乐，陈梓心！愿你永远保持那份热情与专业，继续把光与温暖带给身边的人。
    </div>
</div>
...
<div class="note">
    ...
    <div class="content">
        你负责把事儿安排好，我负责把蛋糕吃掉。愿你永远被热爱环绕，生日快乐！
    </div>
</div>
...
<div id="countdown-container" data-name="陈梓心" data-month="10" data-day="21">
